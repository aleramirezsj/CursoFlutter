...
class DescripcionPlace extends StatelessWidget {
  ...
  DescripcionPlace(
      this.textoTitulo, this.numeroEstrellas, this.textoDescripcion);
  ...
  Widget build(BuildContext context) {
    ...
    final descripcion = Container(
      ...
      child: Text(this.textoDescripcion,
          style: TextStyle(
              fontSize:
                  14.0, //propiedad style: darle estilo a un elemento. widget TextStyle: darle estilos a un elemento tipo texto
              color: Color(0xFF56575a) //color al texto
              ),
          textAlign: TextAlign
              .justify //alineamos el parrafo con un espacio justificado
          ),
    );
